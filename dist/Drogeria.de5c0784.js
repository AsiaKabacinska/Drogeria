...
let ogolnaCena = 0;
let item = 0;
for(let i = 0; i < ceny.length; i++)ceny[i].addEventListener("click", dodajDoKoszyka);
function dodajDoKoszyka(event) {
    ...
    basketSummary.innerHTML = `Ilosc ${item}, warto\u{15B}\u{107}: ${ogolnaCena} PLN`;
}

//# sourceMappingURL=Drogeria.de5c0784.js.map
